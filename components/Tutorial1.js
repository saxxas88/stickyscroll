...
function Sticker() {
  ...
  const onLoad = () => {
    ...
    const stickirize = () => {
      ...
      const currentOffsetElemCenter =
        elem_center.offsetTop / window.innerHeight;
      ...
      if (window.scrollY > 0 && window.scrollY < offsetTopElemCenter) {
        elem_center.style.transform = `translate3d(0,${0}px, 0)`;
        elem_back.style.transform = `translate3d(0,${0}px, 0)`;
        elem_front.style.transform = `translate3d(0,${0}px, 0)`;
      }
      ...
      //first elem sticky
      if (
        window.scrollY >= offsetTopElemBack &&
        window.scrollY <= limitHeight
      ) {
        elem_back.style.transform = `translate3d(0,${Number(
          window.scrollY - offsetTopElemBack
        ).toFixed(2)}px, 0)`;
      }
      ...
      if (
        window.scrollY >=
          offsetTopElemCenter /* && window.scrollY <= offsetTopElemCenter + limitHeight */ &&
        !(window.scrollY > limitHeight)
      ) {
        elem_center.style.transform = `translate3d(0,${Number(
          window.scrollY - offsetTopElemCenter
        ).toFixed(2)}px, 0)`;
      }
      ...
      if (
        window.scrollY >=
          offsetTopElemFront /* && window.scrollY <= offsetTopElemFront + limitHeight */ &&
        !(window.scrollY > limitHeight)
      ) {
        elem_front.style.transform = `translate3d(0,${Number(
          window.scrollY - offsetTopElemFront
        ).toFixed(2)}px, 0)`;
      }
